...
const Navbar = ({openMenu,setOpenMenu,curPage,setCurPage}) => {
  return (
    ...
    style={openMenu?
      ...
      <div id="content" className='flex flex-col w-screen h-screen h-full items-center justify-center'>
        ...
        <MenuItem onClick={()=>{setCurPage('chats')}} id={'chats'} curPage={curPage}>Chats</MenuItem>
        ...
        <div className='cursor-pointer bg-red-500 p-4 font-bold' onClick={()=>{
