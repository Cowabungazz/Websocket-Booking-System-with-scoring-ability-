...
const GameMasterForm = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post(host+'/gm/login', payload).then((res) => {
            localStorage.setItem('gm_token', 'Bearer ' + res.data.token);
            localStorage.setItem('gm_team_name',res.data.team_name)
